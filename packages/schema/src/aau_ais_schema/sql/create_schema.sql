...
create or replace macro ts_to_temporal_part_key(ts) as
    year(ts) * 100 + month(ts);
comment on macro ts_to_temporal_part_key is 'Converts a timestamp to a temporal partitioning key';
--#endregion
--------------------------------------------------------------------------------------
--#region Dimensions
--------------------------------------------------------------------------------------
